...
// Must have already downloaded and installed Google Chrome Canary
// REF: https://www.google.com/chrome/canary/
...
(async () => {
  ...
  const html = fs.readFileSync("./html/speech_synth.html", {
    encoding: "utf-8"
  });
